...
//				openOptionsMenu();
		...
		_leftout_anim=AnimationUtils.loadAnimation(getApplicationContext(), R.anim.leftout_anim);
		_rightout_anim=AnimationUtils.loadAnimation(getApplicationContext(), R.anim.rightout_anim);
		_fadein_anim=AnimationUtils.loadAnimation(getApplicationContext(), R.anim.fadein_anim);
...
/*		vv.setPlayerEventsListener(new VlcPlayer.PlayerEventsListener(){
	...
	public void onSubmitLogin(View v)
	{
		...
		_applySettings(findViewById(R.id.login_l));
